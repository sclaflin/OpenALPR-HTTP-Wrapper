...
export default class Server {
	...
	constructor(port) {
		...
		this.#app.get('/snapShot', (req, res) => this.detectSnap(req, res));
	...
	home(req, res) {
		res.send(`
			...
			<form action="/detect" method="POST" enctype="multipart/form-data">
   			...
   			<h1>OpenALPR HTTP Wrapper for snapshots</h1>
                			<p>This project is a thin wrapper around the <a href="https://github.com/openalpr/openalpr">OpenALPR</a> CLI binary.</p>
                			<p>HTTP GET to /snapShot require a snapshot GET variable and an optional "country_code" value.</p>
                			<h2>Upload an image for License Plate Recognition</h2>
                			<form action="/snapShot" method="GET">
                				...
                				<input type="text" name="snapShotUrl">

                				<input type="submit" value="detectSnap">
                			</form>
		`);
	}
